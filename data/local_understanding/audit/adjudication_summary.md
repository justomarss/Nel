...
This review package maps existing Kimi examples to the frozen Local Understanding v1 taxonomy. It is not training data. Context scenarios remain atomic CHALLENGE_ONLY records.
